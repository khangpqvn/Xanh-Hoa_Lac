...
public class Communicator_Node_Log {
    ...
    public Boolean NodeLog(JSonLogSendModel jSonLogSendModel){
       ...
       logging.setLevel(HttpLoggingInterceptor.Level.BODY);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .baseUrl(SERVER_URL)
                .build(); Interface_Node_Log service = retrofit.create(Interface_Node_Log.class);
                ...
                public void onResponse(Call<LogSyncNode> call, Response<LogSyncNode> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (response.body().getStatus() != null) {
                            BusProvider_Node_Log.getInstance().post(new ServerEvent_Node_Log_From_Server(response.body()));
