...
public class SendPostRequestToGetNodeObjectWebServer extends AsyncTask<String, Void, String> {
 //   Context mContext;
...
//    }
    ...
    public SendPostRequestToGetNodeObjectWebServer(){}
        ...
        protected void onPostExecute(String result) {
           ...
           // Toast.makeText(signinActivity.getApplicationContext(), "Data Sent!", Toast.LENGTH_LONG).show();
            try {
                ...
                String str = "";
               JSONArray nodesObject = json.getJSONArray("nodes");
